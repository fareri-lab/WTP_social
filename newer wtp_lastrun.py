...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\Jojo\\Downloads\\Psychopy\\WTP\\newer wtp.psyexp',
...
text_14 = visual.TextStim(win=win, name='text_14',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0);
rating_6 = visual.RatingScale(win=win, name='rating_6', marker='triangle', size=1.5, pos=[0.0, -0.4], low=1, high=7, labels=['Very Unlikely', ' Unlikely', ' Somewhat Unlikely', ' Neutral', ' Somewhat Likely', ' Likely', ' Very Likely'], scale='')
...
text_17 = visual.TextStim(win=win, name='text_17',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0);
rating_7 = visual.RatingScale(win=win, name='rating_7', marker='triangle', size=1.5, pos=[0.0, -0.4], low=1, high=7, labels=['Very Unlikely', ' Unlikely', ' Somewhat Unlikely', ' Neutral', ' Somewhat Likely', ' Likely', ' Very Likely'], scale='')
...
text_20 = visual.TextStim(win=win, name='text_20',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0);
rating_8 = visual.RatingScale(win=win, name='rating_8', marker='triangle', size=1.5, pos=[0.0, -0.4], low=1, high=7, labels=['Very Unlikely', ' Unlikely', ' Somewhat Unlikely', ' Neutral', ' Somewhat Likely', ' Likely', ' Very Likely'], scale='')
...
text_23 = visual.TextStim(win=win, name='text_23',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0);
rating_9 = visual.RatingScale(win=win, name='rating_9', marker='triangle', size=1.5, pos=[0.0, -0.4], low=1, high=7, labels=['Very Unlikely', ' Unlikely', ' Somewhat Unlikely', ' Neutral', ' Somewhat Likely', ' Likely', ' Very Likely'], scale='')
...
Loop2 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('..\\SocialActivities_df_Final.xlsx'),
...
for thisQuestion in questions:
    ...
    rating_6.reset()
    # keep track of which components have finished
    Q6_2Components = [text_8, text_12, text_13, text_14, rating_6]
    for thisComponent in Q6_2Components:
        if hasattr(thisComponent, 'status'):
            thisComponent.status = NOT_STARTED
    ...
    for thisComponent in Q6_2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # store data for questions (TrialHandler)
    questions.addData('rating_6.response', rating_6.getRating())
    questions.addData('rating_6.rt', rating_6.getRT())
    ...
    rating_7.reset()
    # keep track of which components have finished
    Q7Components = [text_9, text_15, text_16, text_17, rating_7]
    ...
    for thisComponent in Q7Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # store data for questions (TrialHandler)
    questions.addData('rating_7.response', rating_7.getRating())
    questions.addData('rating_7.rt', rating_7.getRT())
    ...
    rating_8.reset()
    # keep track of which components have finished
    q8Components = [text_10, text_18, text_19, text_20, rating_8]
    ...
    for thisComponent in q8Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # store data for questions (TrialHandler)
    questions.addData('rating_8.response', rating_8.getRating())
    questions.addData('rating_8.rt', rating_8.getRT())
    ...
    rating_9.reset()
    # keep track of which components have finished
    q9Components = [text_11, text_21, text_22, text_23, rating_9]
    ...
    for thisComponent in q9Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # store data for questions (TrialHandler)
    questions.addData('rating_9.response', rating_9.getRating())
    questions.addData('rating_9.rt', rating_9.getRT())
