...
function experimentInit() {
  ...
  Instructions = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined, 
    pos: [0, 0.24], height: 0.055,  wrapWidth: 1.7, ori: 0,
   ...
   Instructions2 = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined, 
    pos: [0, -0.09], height: 0.055,  wrapWidth: 1.7, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0 
  });
...
//   Initialize components for example
  ...
  exText_3 = new visual.TextStim({
   ...
   exEndInstructions = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined, 
    pos: [0, 0], height: 0.080,  wrapWidth: 1.8, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0 
  });
...
//   money amounts on the left 
  ...
  Question1 = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined, 
    pos: [0, 0.2], height: 0.08,  wrapWidth: 1.4, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0 
  });
...
//   if they pressed 1, make text green 
  if (response1.keys == '1') {
    leftText1.setColor(new util.Color(greenText2));
  }
  
//   if they pressed 2, make text green 
  if (response1.keys == '2') {
    rightText1.setColor(new util.Color(greenText2));
  }
